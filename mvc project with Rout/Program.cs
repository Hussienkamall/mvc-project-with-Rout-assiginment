namespace mvc_project_with_Rout
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //builder.Services.AddDbContext<ApplicationDbContext>(options =>
            //{
            //    options.UseSqlServer("Server=DESKTOP-A1088VT\\ABDOHAMDY;Database=mvc P;Trusted_Connection=true;TrustServerCertificate=true");
            //});
            #endregion
            ...
            //    optionBuilder.UseSqlServer("Server=DESKTOP-A1088VT\\ABDOHAMDY;Database=mvc P;Trusted_Connection=true;TrustServerCertificate=true");
